...
function reset_sketch(){
  ...
  text(" If you like my work please consider sending Hbar at the address \n below. If you dont want to or are not able to no worries and hope \n you enjoy.", 470, 510);
  
  text("0.0.829445", 473, 570);
}
